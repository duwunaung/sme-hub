...
exports.orgs = (req, res) => {
    if (req.method == 'GET') {
        ...
        axios.get(`${process.env.API_URL}/organizations?page=${page}&name=${name}&expired=${expired}&status=${status}`, {
            ...
            if (error) {
                if (type == 'register') {
                    res.render('superadmin/organizations', { orgs: response.data.data, pagination: response.data.pagination, name: name, options: options, errorMessage: "Cannot register at the moment!" , successMessage: null});
                } else if (type == '404Error') {
                    res.render('superadmin/organizations', { orgs: response.data.data, pagination: response.data.pagination, name: name, options: options, errorMessage: "404 Organization Not Found!" , successMessage: null});
                } else if (type == 'sysError') {
                    res.render('superadmin/organizations', { orgs: response.data.data, pagination: response.data.pagination, name: name, options: options, errorMessage: "Internal Server Error!" , successMessage: null});
                }
            } else if (success) {
				if (type === 'register') {
					res.render('superadmin/organizations', { orgs: response.data.data, pagination: response.data.pagination, name: name, status: status, options: options, errorMessage: null , successMessage: "Successfully created!"});
				} else if (type === 'org-delete') {
					res.render('superadmin/organizations', { orgs: response.data.data, pagination: response.data.pagination, name: name, status: status, options: options, errorMessage: null , successMessage: "Successfully deleted!"});
				} else if (type === 'org-restore') {
					res.render('superadmin/organizations', { orgs: response.data.data, pagination: response.data.pagination, name: name, status: status, options: options, errorMessage: null , successMessage: "Successfully restored!"});
				}
            }
			else {
                res.render('superadmin/organizations', { orgs: response.data.data, pagination: response.data.pagination, name: name, status: status, options: options, errorMessage: null , successMessage: null});
            }
        }).catch(error => {
            ...
            axios.get(`${process.env.API_URL}/organizations/users/${orgId}?page=${userPage}&name=${userName}&status=${userStatus}&role=${userRole}`, {
                ...
                if (error) {
                    if (req.query.type == 'user-create') {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: "Cannot create user at the moment!", successMessage: null });
                    } else if (req.query.type == 'user-delete') {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: "Cannot delete user at the moment!", successMessage: null });
                    } else if (req.query.type == 'user-restore') {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: "Cannot restore user at the moment!", successMessage: null });
                    } else if (req.query.type == 'dup-email') {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: "Duplicate Email!", successMessage: null });
                    } else if (req.query.type == '404Error') {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: "404 User Not Found!", successMessage: null });
                    } else {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: "Internal Server Error!", successMessage: null });
                    }
                } else {
                    if (req.query.type == 'user-create') {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: null, successMessage: "User Created" });
                    } else if (req.query.type == 'user-delete') {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: null, successMessage: "User Deleted" });
                    } else if (req.query.type == 'user-restore') {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: null, successMessage: "User Restored" });
                    } else {
                        res.render('superadmin/detail-organization', { org: response.data.data, users: users.data.data, name: userName, orgPage: orgPage, pagination: users.data.pagination, options: options, status: userStatus, role: userRole, roles: roles, errorMessage: null, successMessage: null });
                    }
                }
            }).catch(error => {
                res.render('superadmin/detail-organization', { org: {}, users: [], name: {}, orgPage: orgPage, pagination: {}, errorMessage: "System Error!", options: options, status: userStatus, role: userRole, roles: roles, successMessage: null });
            })
        }).catch(error => {
			if (error.status == 404) {
    ...
    if (req.method == 'GET') {
        ...
        axios.get(`${process.env.API_URL}/utils/users?page=${page}&name=${name}&status=${status}`, {
            ...
            if (req.query.success) {
                if (req.query.type == 'user-create') {
                    res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: null, successMessage: "Successfully created." });
                } else if (req.query.type == 'user-delete') {
                    res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: null, successMessage: "Successfully deleted." });
                } else if (req.query.type == 'user-restore') {
                    res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: null, successMessage: "Successfully restored." });
                }
            } else if (req.query.error) {
                if (req.query.type == 'user-create') {
                    res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: "Cannot create at the moment!", successMessage: null });
                } else if (req.query.type == 'user-delete') {
                    res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: "Cannot delete at the moment!", successMessage: null });
                } else if (req.query.type == 'user-restore') {
                    res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: "Cannot restore at the moment!", successMessage: null });
                } else if (req.query.type == '404Error') {
					res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: "404 User Not Found!", successMessage: null });
				} else if (req.query.type == 'sysError') {
					res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: "Internal Server Error!", successMessage: null });
				}
            } else {
                res.render('superadmin/superadmins', { users: response.data.data, pagination: response.data.pagination, name: name, errorMessage: null, successMessage: null });
            }
        }).catch(error => {
            res.render('superadmin/superadmins', { users: [], pagination: {}, name: {}, errorMessage: "System Error!", successMessage: null });
        })
    }
}
